...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/public/datetime/jquery.datetimepicker.min.css"/>
    ...
    <div class="main-panel">
        <div class="content">
            <div style=" width: 90%;  margin: 10px auto;">
                            ...
                            <table id="example" class="table" style="width:100%">
                                <thead >
                                    <tr>
                                        ...
                                        <td class="filas"><b>Modificacion Informacion</b></td>
                                        <td class="filas"><b>Modificacion Documentos</b></td>
                                    </tr>
                                </thead>
                ...
                <script src="<?php echo base_url(); ?>/public/jquery/jquery-3.5.1.min.js"></script>
                <script src="<?php echo base_url(); ?>/public/popper/popper.min.js"></script>
                <script src="<?php echo base_url(); ?>/public/bootstrap/js/bootstrap.min.js"></script>
                <script type="text/javascript" src="<?php echo base_url(); ?>/public/datatables/datatables.min.js"></script>    
                <script src="<?php echo base_url(); ?>/public/datatables/Buttons-1.5.6/js/dataTables.buttons.min.js"></script>  
                ...
                <script src="<?php echo base_url(); ?>/public/datatables/Buttons-1.5.6/js/buttons.html5.min.js"></script>  
                <script  src="<?php echo base_url(); ?>/public/datatables.js"></script>
                <script src="<?php echo base_url(); ?>/public/bootstrap/js/bootstrap-notify/bootstrap-notify.min.js"></script>
                <script src="<?php echo base_url(); ?>/public/datetime/jquery.datetimepicker.full.js"></script>
